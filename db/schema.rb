...
ActiveRecord::Schema.define(version: 2018_11_27_055557) do
  ...
  create_table "workspace_owners", force: :cascade do |t|
    t.string "user_name"
    t.string "email"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "workspaces", force: :cascade do |t|
    ...
    t.bigint "workspace_owner_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_workspaces_on_category_id"
    t.index ["workspace_owner_id"], name: "index_workspaces_on_workspace_owner_id"
  end

  add_foreign_key "reviews", "workspaces"
  add_foreign_key "workspaces", "categories"
  add_foreign_key "workspaces", "workspace_owners"
end
